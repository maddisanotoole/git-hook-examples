...
[send-message-to-slack](hooks/examples//post-merge.send-slack-message): Send messages to slack when certain actions happen (e.g. if a branch is merged).
Pre-requisite [set up a webhook for your Slack workspace](https://api.slack.com/messaging/webhooks).
Update the example url in the script with your generated webhook url

![Webhook slack message](screenshots/send-slack-message.png)
